...
My goal is to become a top developer and create projects that I will be proud of! 🚀</p>
        <div className="row mb-4">
          ...
          <div className="col-sm-6 py-1">
            <span className="fw-medium text-primary">Birthday:</span> 19 June 2007
          </div>
          <div className="col-sm-6 py-1">
          ...
          <div className="col-sm-6 py-1">
            <span className="fw-medium text-primary">Phone:</span> +9989 (95) 878 62 77
          </div>
          <div className="col-sm-6 py-1">
            <span className="fw-medium text-primary">Email:</span> akromjonrustamov56@gmail.com
          </div>
          <div className="col-sm-6 py-1">
            <span className="fw-medium text-primary">Address:</span> Uzbekistan, Tashkent, Bektemir
          </div>
          <div className="col-sm-6 py-1">
